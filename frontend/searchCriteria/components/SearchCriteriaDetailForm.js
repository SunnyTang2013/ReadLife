...
export default class SearchCriteriaDetailForm extends React.Component {
  ...
  constructor(props) {
    super(props);
    this.state = {
      input: cloneDeep(props.searchCriteriaDetail),
  ...
  onRunSearch() {
    ...
    if (input) {
      this.setState({ loadingJobs: true, openJobListPanel: true }, () => {
        const defaultQuery = SearchCriteriaDetailForm.getDefaultQuery();
...
SearchCriteriaDetailForm.propTypes = {
  searchCriteriaDetail: ScorchPropTypes.searchCriteria().isRequired,
  onSave: PropTypes.func.isRequired,
  onCancel: PropTypes.func.isRequired,
  disabled: PropTypes.bool,
};

SearchCriteriaDetailForm.defaultProps = {
  disabled: false,
};
